...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_CREATE()
	ON_COMMAND(ID_VIEW_FUNDSELECTION, OnViewFundselection)
	ON_UPDATE_COMMAND_UI(ID_VIEW_FUNDSELECTION, OnUpdateViewFundselection)
	ON_WM_ACTIVATEAPP()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CMainFrame::OnViewFundselection() 
{
	SetFundsVisible( m_bFundsVisible ? FALSE : TRUE );	

}

void CMainFrame::OnUpdateViewFundselection(CCmdUI* pCmdUI) 
{
	BOOL bEnable = FALSE;
...
/*
	// Disable for Active Document Version
	if( bActive )
	{
		if( AreFundsVisible()) 
